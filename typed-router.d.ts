...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'apps-branch-list': RouteRecordInfo<'apps-branch-list', '/apps/branch/list', Record<never, never>, Record<never, never>>,
    'apps-branch-settlement-branch-excution': RouteRecordInfo<'apps-branch-settlement-branch-excution', '/apps/branch/settlement/branchExcution', Record<never, never>, Record<never, never>>,
    'apps-branch-settlement-date': RouteRecordInfo<'apps-branch-settlement-date', '/apps/branch/settlement/date', Record<never, never>, Record<never, never>>,
    'apps-branch-settlement-list-paid': RouteRecordInfo<'apps-branch-settlement-list-paid', '/apps/branch/settlement/listPaid', Record<never, never>, Record<never, never>>,
    'apps-branch-settlement-member': RouteRecordInfo<'apps-branch-settlement-member', '/apps/branch/settlement/member', Record<never, never>, Record<never, never>>,
    ...
    'apps-member-cancellation': RouteRecordInfo<'apps-member-cancellation', '/apps/member/cancellation', Record<never, never>, Record<never, never>>,
    'apps-member-date': RouteRecordInfo<'apps-member-date', '/apps/member/date', Record<never, never>, Record<never, never>>,
    'apps-member-execute': RouteRecordInfo<'apps-member-execute', '/apps/member/execute', Record<never, never>, Record<never, never>>,
    'apps-member-list-paid': RouteRecordInfo<'apps-member-list-paid', '/apps/member/listPaid', Record<never, never>, Record<never, never>>,
    'apps-member-member': RouteRecordInfo<'apps-member-member', '/apps/member/member', Record<never, never>, Record<never, never>>,
    'apps-others-bank': RouteRecordInfo<'apps-others-bank', '/apps/others/bank', Record<never, never>, Record<never, never>>,
    'apps-others-connection': RouteRecordInfo<'apps-others-connection', '/apps/others/connection', Record<never, never>, Record<never, never>>,
    'apps-others-notification': RouteRecordInfo<'apps-others-notification', '/apps/others/notification', Record<never, never>, Record<never, never>>,
    'apps-others-report': RouteRecordInfo<'apps-others-report', '/apps/others/report', Record<never, never>, Record<never, never>>,
    'apps-others-settings': RouteRecordInfo<'apps-others-settings', '/apps/others/settings', Record<never, never>, Record<never, never>>,
    ...
    'apps-user-diagram-recommediation': RouteRecordInfo<'apps-user-diagram-recommediation', '/apps/user/diagram/recommediation', Record<never, never>, Record<never, never>>,
    'apps-user-diagram-sponsorship': RouteRecordInfo<'apps-user-diagram-sponsorship', '/apps/user/diagram/sponsorship', Record<never, never>, Record<never, never>>,
